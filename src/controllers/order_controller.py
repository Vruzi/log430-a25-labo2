...
from queries.read_order import get_orders_from_mysql, get_orders_from_redis, get_highest_sold_products, get_highest_spending_users
...
def get_report_best_sellers():
    ...
    return get_highest_sold_products()